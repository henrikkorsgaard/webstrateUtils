...
(function(){
	...
	root.appendChild(self);      
		...
		updateObserver.observe(root, { attributes: true, childList: true, characterData: false });
      	presenceObserver.observe(self, { attributes: true, childList: false, characterData: false });
		timer = setInterval(tick, interval);	
